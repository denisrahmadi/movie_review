          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="blog__details__hero__text">
                <h2>{{ $route.query.item.name }}</h2>
                <ul>
                  <li>{{ $route.query.item.category }}</li>
                  <li>Rerelease: {{ $route.query.item.year_release }}</li>
                </ul>
              </div>
            </div>
          </div>
            ...
            <div class="col-lg-8 col-md-4 blog__details__content">
              <div class="blog__details__text">
                <div class="blog__details__text__img">
                  <img :src="$route.query.item.image_url" alt="" />
                </div>
                <p>
                  {{ $route.query.item.review }}
                </p>
              </div>
            </div>
          </div>
