        ...
        <form>
          <div class="row">
            ...
            <div class="genre__input__checkbox">
              <label> 
                <input type="radio" name="genre" value="All" v-model="movieData.category" /> All 
              </label>
              <label>
                <input type="radio" name="genre" value="Actions" v-model="movieData.category" /> Actions 
              </label>
              <label>
                <input type="radio" name="genre" value="Science Fiction" v-model="movieData.category" /> Science Fiction 
              </label>
              <label>
                <input type="radio" name="genre" value="Horror" v-model="movieData.category" /> Horror </label>
              <label>
                <input type="radio" name="genre" value="Thriller" v-model="movieData.category" /> Thriller 
              </label>
              <label>
                <input type="radio" name="genre" value="Comedy" v-model="movieData.category" /> Comedy 
              </label>
              <label>
                <input type="radio" name="genre" value="Romance" v-model="movieData.category" /> Romance 
              </label>
              <label>
                <input type="radio" name="genre" value="Adventure" v-model="movieData.category" /> Adventure 
              </label>
              <label>
                <input type="radio" name="genre" value="Fantasy" v-model="movieData.category" /> Fantasy
              </label>
            </div>
